...
public class _XorderItems_Stub extends Stub implements XorderItems {
    ...
    public Long getOrdersId() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("_get_ordersId", true);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (Long) in.read_value(Long.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("_get_ordersId",com.ibm.commerce.extension.objects.XorderItems.class);
                if (so == null) {
                    continue;
                }
                try {
                    Long result = ((com.ibm.commerce.extension.objects.XorderItems)so.servant).getOrdersId();
                    return (Long)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
    ...
    public Long getOrderItemsId() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("_get_orderItemsId", true);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (Long) in.read_value(Long.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("_get_orderItemsId",com.ibm.commerce.extension.objects.XorderItems.class);
                if (so == null) {
                    continue;
                }
                try {
                    Long result = ((com.ibm.commerce.extension.objects.XorderItems)so.servant).getOrderItemsId();
                    return (Long)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
    ...
    public Integer getOrderLineItemId() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("_get_orderLineItemId", true);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                ...
                ServantObject so = _servant_preinvoke("_get_orderLineItemId",com.ibm.commerce.extension.objects.XorderItems.class);
                if (so == null) {
                    continue;
                }
                try {
                    Integer result = ((com.ibm.commerce.extension.objects.XorderItems)so.servant).getOrderLineItemId();
    ...
    public String getSalesOrderId() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("_get_salesOrderId", true);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                ...
                ServantObject so = _servant_preinvoke("_get_salesOrderId",com.ibm.commerce.extension.objects.XorderItems.class);
                if (so == null) {
                    continue;
                }
                try {
                    return ((com.ibm.commerce.extension.objects.XorderItems)so.servant).getSalesOrderId();
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
