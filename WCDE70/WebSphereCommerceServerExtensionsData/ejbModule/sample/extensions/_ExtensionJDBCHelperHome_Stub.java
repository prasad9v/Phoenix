...
public class _ExtensionJDBCHelperHome_Stub extends Stub implements ExtensionJDBCHelperHome {
    
    private static final String[] _type_ids = {
        "RMI:sample.extensions.ExtensionJDBCHelperHome:0000000000000000", 
            ...
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ExtensionJDBCHelper) in.read_Object(ExtensionJDBCHelper.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",sample.extensions.ExtensionJDBCHelperHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ExtensionJDBCHelper result = ((sample.extensions.ExtensionJDBCHelperHome)so.servant).create();
                    return (ExtensionJDBCHelper)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
